...
def create_supervised_trainer_with_center(model, center_criterion, optimizer, optimizer_center, loss_fn, cetner_loss_weight,
    ...
    def _update(engine, batch):
        ...
        for param in center_criterion.parameters():
            ...
            # param.data *= (1. / cetner_loss_weight)
...
def do_train(
    ...
    logger = logging.getLogger(f"reid_baseline_{cfg.DATASETS.NAMES}.train")
    ...
    checkpointer = ModelCheckpoint(output_dir, cfg.MODEL.NAME, checkpoint_period, n_saved=120, require_empty=False, save_as_state_dict=state_dict)
